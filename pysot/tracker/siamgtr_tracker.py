...
class SiamGTRTracker(SiameseTracker):
    def __init__(self, model, cfg):
        super(SiamGTRTracker, self).__init__()
    ...
    def track(self, img):
        ...
        # if cfg.TRACK.hanming or not self.longterm_state:
        ...
        if cfg.TRACK.hanming or not self.longterm_state:
            ...
            hp_score = p_score*(1-0.001)+self.window * 0.001
        ...
        best_score = p_score_up[max_r_up,max_c_up]
